...
Synopsis::Synopsis(Trajectory *pTraj) 
{
	traj = pTraj;     
    total_duration = 0.0;                      
}
...
//Function that updates the synopsis of a trajectory, inserting a new incoming point
double Synopsis::updateSynopsis(point *pnt, unordered_map< unsigned int, unsigned int > *U, int t, int s, unordered_map< unsigned int, unsigned int > *lastQID, unordered_set<unsigned int> *randomQ)
{
